...
function hideDetail() { selectedFeature = null; $("detail-card").classList.remove("compact-note-editor"); $("detail-card").hidden = true; $("detail-photo").src = ""; $("detail-link").hidden = true; $("symbol-editor").hidden = true; $("text-editor").hidden = true; }
